...
from ..static.lib.to_predict import model_predict, garbage_t, get_modelPath
...
def cam_or_file():
    ...
    return render_template('result/result.html', acc=acc[max_index], garbage=garbage, garbage_type=grabage_type_cn,
                           ...
                           prevent=prevent, filename=filename, img_dir=img_dir, labels=labels, acc_arr=acc,
                           max_index=max_index, open_camera=open_c)
